exports.config = {
  ...
  cucumberOpts: {
    require: ['./src/**/*.js'],        // <string[]> (file/dir) require files before executing features
  ...
  afterStep(stepResult) {
    const name = `ERROR--${browser.desiredCapabilities.browserName}_${Date.now()}`;
    browser.saveScreenshot(`./reports/screenshot/ ${name}.png`);
  },
  /**
